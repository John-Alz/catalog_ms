...
import com.eatshub.catalog.infrastructure.adapters.mongodb.mapper.ReservationMapper;
...
public class ReservationAdapter implements ReservationGateway {
    ...
    public Mono<ReservationModel> createReservation(ReservationModel reservation) {
        ...
        return reservationValidator.applyValidations(reservation, validations)
                ...
                .flatMap(item -> reservationRepository.save(ReservationMapper.MAPPER.toEntity(reservation)))
                .map(ReservationMapper.MAPPER::toModel)
    ...
    public Mono<ReservationModel> updateReservation(ReservationModel updateReservation, UUID reservationId) {
        ...
        return validateExistReservation(reservationId)
                ...
                .flatMap(reservation -> {
                    ...
                    return reservationRepository.save(ReservationMapper.MAPPER.toEntity(reservation))
                            .map(ReservationMapper.MAPPER::toModel)
